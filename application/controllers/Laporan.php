...
class Laporan extends CI_Controller
{
  ...
  public function laporan_pinjam()
  {
      ...
      $data['user'] = $this->ModelUser->cekData(['email' => $this->session->userdata('email')])->row_array();
      $data['laporan'] = $this->db->query("select * from pinjam1 p,detail_pinjam1 d,
          buku1 b,user1 u where d.id_buku=b.id and p.id_user=u.id
  ...
  public function export_excel_pinjam()
  {
    ...
    'laporan' => $this->db->query("select * from pinjam1 p,detail_pinjam1 d,
    buku1 b,user1 u where d.id_buku=b.id and p.id_user=u.id
    and p.no_pinjam=d.no_pinjam")->result_array());
